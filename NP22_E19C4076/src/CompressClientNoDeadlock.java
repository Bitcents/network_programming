...
public class CompressClientNoDeadlock {
  ...
  public static void main(String[] args) throws IOException {
    ...
    byte[] messageBuffer = new byte[44]; // Set the message buffer size to the size of the greeting from the server
    sockIn.read(messageBuffer);
    System.out.println(new String(messageBuffer));
